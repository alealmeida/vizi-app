...
import { setAuthLoading, setAuthError, setAuthToken, clearAuth } from '@features/auth/state/authSlice';
import { setUserProfile } from '@features/user/state/userSlice';
import { bootstrapUserFromUsuarioMe } from '@features/user/state/thunks';
import type { AppDispatch, RootState } from '@/store';

import { loginRest, type LoginInput } from '@features/auth/api/login';
import { registerRest, type RegisterInput } from '@features/auth/api/register';
